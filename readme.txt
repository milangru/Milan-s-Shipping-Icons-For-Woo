...
Displays a custom courier/shipping logo next to each shipping method on the Cart page, Checkout page, order confirmation, and order emails.
...
* Simple settings screen under WooCommerce → Settings → Shipping Icons
...
Each shipping method (per shipping zone) gets its own icon field. Once saved, the plugin automatically matches the selected shipping method to its icon and displays it wherever that method's name appears to the customer.
...
4. Go to WooCommerce → Settings → Shipping Icons.
5. Choose an icon for each shipping method and click Save changes.
...
2. Icons displayed next to shipping methods at Checkout
3. Icon displayed in the Cart Totals panel
